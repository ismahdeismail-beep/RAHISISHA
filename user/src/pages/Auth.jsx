    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          {mode === 'signup' && (
            <div className="auth-row">
              ...
              <div className="auth-field">
                ...
                <input type="text" placeholder="Mwangi" required />
              </div>
            </div>
          )}
          ...
          <div className="auth-field">
            ...
            <input
              ...
              defaultValue="jane@rahisisha.co"
              required
            />
          </div>
          ...
          {mode === 'login' && (
            <a href="#forgot" className="auth-forgot" onClick={(e) => { e.preventDefault(); alert('Reset link sent! (Demo)'); }}>
              Forgot password?
            </a>
          )}
        ...
        <button
          ...
          onClick={() => { alert('✅ Google Sign In (Demo)'); navigate('/overview'); }}
        >
      ...
      <style>{`
        ...
        .auth-tabs {
          display: flex; background: var(--bg); border-radius: 10px; padding: 3px; margin-bottom: 24px;
        }
        .auth-tab {
        ...
        .auth-forgot {
          text-align: right; font-size: 0.78rem; color: var(--teal-text);
          text-decoration: none; font-weight: 500; margin-top: -4px;
        }
        ...
        .auth-footer {
          text-align: center; font-size: 0.72rem; color: var(--text-dim); margin-top: 20px; line-height: 1.5;
        }
        .auth-footer a { color: var(--teal-text); text-decoration: none; }
